...
const Data = () => {
  return (
   <div className="home__data">
    <h1 className="home__title">Sammy
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <h3 className="home__subtitle">Tech Entrepreneur</h3>
    <p className="home__description">I am a web developer, editor and cloud engineering student based in Lagos, with a deep passion for my work.</p>
